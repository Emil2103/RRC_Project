...
static asn_TYPE_member_t asn_MBR_RRCConnectionSetupComplete_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionSetupComplete, messageHeader),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionSetupComplete, integrityProtectionAlgorithm),
...
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionSetupComplete_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (2 << 2)), 1, 0, 0 }, /* integrityProtectionAlgorithm */
